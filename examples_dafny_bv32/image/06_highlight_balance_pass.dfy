...
// Category: image
// Example: 06_highlight_balance_pass
  ...
  decreases *
{
  ...
  p := Pixel(
    BlendChannel(base.r, ex.r, (3 as bv32), ey.r, (13 as bv32), blur.r, (3 as bv32), (31 as bv32)),
    BlendChannel(base.g, ex.g, (13 as bv32), ey.g, (3 as bv32), blur.g, (7 as bv32), (18 as bv32)),
    BlendChannel(base.b, ex.b, (7 as bv32), ey.b, (13 as bv32), blur.b, (3 as bv32), (9 as bv32))
  );
}
