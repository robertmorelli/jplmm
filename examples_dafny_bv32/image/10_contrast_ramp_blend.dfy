...
// Category: image
// Example: 10_contrast_ramp_blend
  ...
  decreases *
{
  ...
  p := Pixel(
    BlendChannel(base.r, ex.r, (3 as bv32), ey.r, (10 as bv32), blur.r, (7 as bv32), (43 as bv32)),
    BlendChannel(base.g, ex.g, (10 as bv32), ey.g, (3 as bv32), blur.g, (12 as bv32), (26 as bv32)),
    BlendChannel(base.b, ex.b, (12 as bv32), ey.b, (10 as bv32), blur.b, (7 as bv32), (13 as bv32))
  );
}
