...
// Category: image
// Example: 12_embossed_luma_stack
  ...
  decreases *
{
  ...
  p := Pixel(
    BlendChannel(base.r, ex.r, (5 as bv32), ey.r, (12 as bv32), blur.r, (4 as bv32), (49 as bv32)),
    BlendChannel(base.g, ex.g, (12 as bv32), ey.g, (5 as bv32), blur.g, (11 as bv32), (30 as bv32)),
    BlendChannel(base.b, ex.b, (11 as bv32), ey.b, (12 as bv32), blur.b, (4 as bv32), (15 as bv32))
  );
}
