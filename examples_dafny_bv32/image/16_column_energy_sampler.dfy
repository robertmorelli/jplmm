...
// Category: image
// Example: 16_column_energy_sampler
  ...
  decreases *
{
  ...
  p := Pixel(
    BlendChannel(base.r, ex.r, (5 as bv32), ey.r, (9 as bv32), blur.r, (3 as bv32), (61 as bv32)),
    BlendChannel(base.g, ex.g, (9 as bv32), ey.g, (5 as bv32), blur.g, (9 as bv32), (38 as bv32)),
    BlendChannel(base.b, ex.b, (9 as bv32), ey.b, (9 as bv32), blur.b, (3 as bv32), (19 as bv32))
  );
}
