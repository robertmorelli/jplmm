...
// Category: image
// Example: 18_sharpened_edge_stack
  ...
  decreases *
{
  ...
  p := Pixel(
    BlendChannel(base.r, ex.r, (3 as bv32), ey.r, (11 as bv32), blur.r, (5 as bv32), (67 as bv32)),
    BlendChannel(base.g, ex.g, (11 as bv32), ey.g, (3 as bv32), blur.g, (8 as bv32), (42 as bv32)),
    BlendChannel(base.b, ex.b, (8 as bv32), ey.b, (11 as bv32), blur.b, (5 as bv32), (21 as bv32))
  );
}
