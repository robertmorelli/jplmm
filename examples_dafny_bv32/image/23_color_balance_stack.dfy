...
// Category: image
// Example: 23_color_balance_stack
  ...
  decreases *
{
  ...
  p := Pixel(
    BlendChannel(base.r, ex.r, (4 as bv32), ey.r, (9 as bv32), blur.r, (5 as bv32), (82 as bv32)),
    BlendChannel(base.g, ex.g, (9 as bv32), ey.g, (4 as bv32), blur.g, (9 as bv32), (52 as bv32)),
    BlendChannel(base.b, ex.b, (9 as bv32), ey.b, (9 as bv32), blur.b, (5 as bv32), (26 as bv32))
  );
}
