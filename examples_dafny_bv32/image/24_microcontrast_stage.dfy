...
// Category: image
// Example: 24_microcontrast_stage
  ...
  decreases *
{
  ...
  p := Pixel(
    BlendChannel(base.r, ex.r, (5 as bv32), ey.r, (10 as bv32), blur.r, (6 as bv32), (85 as bv32)),
    BlendChannel(base.g, ex.g, (10 as bv32), ey.g, (5 as bv32), blur.g, (12 as bv32), (54 as bv32)),
    BlendChannel(base.b, ex.b, (12 as bv32), ey.b, (10 as bv32), blur.b, (6 as bv32), (27 as bv32))
  );
}
