...
describe("parseSource", () => {
  ...
  it("recovers from tokenizer failures as parse diagnostics", () => {
    const r = parseSource("fn f(x:int): int { ret @; }");
