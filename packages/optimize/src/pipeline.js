...
import { validateCanonicalizePassCertificate, validateClosedFormPassCertificate, validateGuardEliminationPassCertificate, validateLutPassCertificate, } from "./certificates";
...
export function optimizeProgram(program, options = {}) {
    ...
    const canonicalValidation = validateCanonicalizePassCertificate(program, canonicalCandidate.program, canonicalCertificate);
    ...
    if (!disabledPasses.has("guard_elimination")) {
        ...
        const guardCandidateCertificate = {
        ...
        const guardValidation = validateGuardEliminationPassCertificate(current, guardCandidate.program, guardCandidateCertificate);
