import { isNaNlessCanonical, matchClosedForms } from "@jplmm/optimize";
export function validateCanonicalizeCertificate(rawProgram, canonicalProgram, certificate) {
...
export function validateRangeAnalysisCertificate(program, certificate) {
...
export function validateGuardEliminationCertificate(canonicalProgram, guardProgram, certificate) {
    const canonicalCounts = countProgramOps(canonicalProgram);
...
export function validateIdentityCertificate(certificate) {
    return {
        kind: "identity",
...
export function validateClosedFormCertificate(program, certificate) {
...
export function validateLutCertificate(certificate) {
...
export function revalidateCertificate(edges, from, to, baselineProgram, refinedProgram, rangeAnalysis = null) {
    void rangeAnalysis;
...
function collectExprIds(expr, out) {
    if (out.has(expr.id)) {
        return;
    }
    out.add(expr.id);
...
//# sourceMappingURL=compiler_ladder_certificates.js.map