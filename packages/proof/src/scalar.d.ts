...
export declare function emitValueChange(current: SymValue, next: SymValue, type: Type): string | null;
export declare function emitValueEquality(current: SymValue, next: SymValue, type: Type): string | null;
export declare function emitArrayEquality(left: SymArray, right: SymArray): string | null;
...
export declare function strictDecrease(currentMeasure: ScalarExpr, nextMeasure: ScalarExpr): string;
export declare function emitAbsoluteMeasure(expr: ScalarExpr): string;
export declare function emitScalar(expr: ScalarExpr): string;
export declare function emitScalarWithOverrides(expr: ScalarExpr, overrides?: {
...
export declare function emitArrayReadWithOverrides(array: SymArray, indices: ScalarExpr[], valueType: ScalarTag, overrides?: {
    onVar?: (expr: Extract<ScalarExpr, {
        tag: "var";
    }>) => string | null;
}): string;
...
export declare function queryCounterexample(query: CounterexampleQuery): string | null;
